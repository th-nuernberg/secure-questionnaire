const mappings = {
  ...
  birne: ["birne", "birnen"],
  block:["block", "schreibblock", "notizblock"],
  blume: ["blume", "blumen", "blüte"],
  bonbon:[" bonbon", "bonbons","süßigkeit"],
  brief: ["brief", "schreiben", "post", "liebebrief", "briefe"],
  buch: ["buch", "lektüre"],
  büroklammer: [" büroklammer", "klammer", "briefklammer", "heftklammer"],
  drache:["drache", "drachen"],
  eis:["eis", "eiscreme", "speiseeis"],
  erdbeere: ["erdbeere", "beere", "erdbeeren"],
  fahrrad: ["fahrrad", "rad", "bike", "drahtesel"],
  federball: ["federball", "badminton"],
  ...
  kaktus: ["kaktus", "kaktee", "sukkulente"],
  kirsche: ["kirsche", "kirschen"],
  kiste: ["kiste", "box", "schachtel"],
  knopf: ["knopf", "knöpfe"],
  koffer: ["koffer", "gepäck"],
  nagel: ["nagel", "bolzen"],
  paket: ["paket", "sendung", "päckchen"],
  papagei: ["papagei", "wellensittich", "kakadu"],
  pfeife: ["pfeife", "pfeifen"],
  pferd: ["pferd", "ross", "gaul", "schimmel", "hengst"],
  pinguin: ["pinguin", "eisvogel"],
  schaufel: ["schaufel", "schippe"],
  schirm: ["schirm", "regenschirm", "parapluie"],
  schleife: ["schleife"],
  schraubenzieher: ["schraubenzieher", "schraubendreher"],
  schwein: ["schwein", "wutz", "sau", "wildschwein", "wildsau"],
  stift: ["stift", "schreibstift", "bleistift"],
  streichholz: ["streichholz", "zünder", "zündholz"],
  stuhl: ["stuhl", "sitzplatz", "platz", "sitzgelegenheit"],
  tasche: ["tasche", "handtasche", "tragetasche", "taschen"],
  tasse: ["tasse", "becher"],
  teddy: ["teddy", "teddybär", "stofftier", "kuschelbär"],
  trichter: ["trichter"],
