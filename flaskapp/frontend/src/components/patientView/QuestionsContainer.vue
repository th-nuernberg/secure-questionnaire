  ...
  <div>
    ...
    >
      <component
        :is="question.type"
        :question="question"
        :storedAnswer="getStoredAnswer(question.id)"
...
export default {
  ...
  methods: {
    getInputFromChild(questionID, answer) {
      if (this.$parent.getInputFromChild == undefined) {
        //in CollapseNavigation wird automatisch accordeon-Komponente eingef�gt
